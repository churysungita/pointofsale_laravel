...
<div class="col-lg-4 col-xs-6">
    ...
    <div class="col-lg-4 col-xs-6">
        ...
        <div class="small-box bg-red">
            ...
            <a href="{{ route('expenditure.index') }}" class="small-box-footer">View <i class="fa fa-arrow-circle-right"></i></a>
        </div>
    </div>
    <!-- ./col -->
    ...
    <div class="col-lg-12">
        <div class="box">
            <div class="box-header with-border">
                {{-- <h3 class="box-title">Income Chart {{ tanzanian_date($start_date, false) }} - {{ tanzanian_date($end_date, false) }}</h3> --}}
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                <div class="row">
